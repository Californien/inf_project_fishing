globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///workspaces/inf_project_fishing/nuxt_frontend/node_modules/node-fetch-native/dist/polyfill.mjs';
...
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///workspaces/inf_project_fishing/nuxt_frontend/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///workspaces/inf_project_fishing/nuxt_frontend/node_modules/devalue/index.js';
import { renderToString } from 'file:///workspaces/inf_project_fishing/nuxt_frontend/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///workspaces/inf_project_fishing/nuxt_frontend/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///workspaces/inf_project_fishing/nuxt_frontend/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///workspaces/inf_project_fishing/nuxt_frontend/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///workspaces/inf_project_fishing/nuxt_frontend/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///workspaces/inf_project_fishing/nuxt_frontend/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///workspaces/inf_project_fishing/nuxt_frontend/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///workspaces/inf_project_fishing/nuxt_frontend/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///workspaces/inf_project_fishing/nuxt_frontend/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///workspaces/inf_project_fishing/nuxt_frontend/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///workspaces/inf_project_fishing/nuxt_frontend/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///workspaces/inf_project_fishing/nuxt_frontend/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///workspaces/inf_project_fishing/nuxt_frontend/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///workspaces/inf_project_fishing/nuxt_frontend/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file:///workspaces/inf_project_fishing/nuxt_frontend/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///workspaces/inf_project_fishing/nuxt_frontend/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///workspaces/inf_project_fishing/nuxt_frontend/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/workspaces/inf_project_fishing/nuxt_frontend/src/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/workspaces/inf_project_fishing/nuxt_frontend","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/workspaces/inf_project_fishing/nuxt_frontend/src/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/workspaces/inf_project_fishing/nuxt_frontend/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/workspaces/inf_project_fishing/nuxt_frontend/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/workspaces/inf_project_fishing/nuxt_frontend/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _8APzE54FYU = (function(nitro) {
...
const _lazy_xmnZUL = () => Promise.resolve().then(function () { return renderer$1; });
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[],"noscript":[],"title":"Online-Banking"};
...
const getClientManifest = () => import('file:///workspaces/inf_project_fishing/nuxt_frontend/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///workspaces/inf_project_fishing/nuxt_frontend/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
