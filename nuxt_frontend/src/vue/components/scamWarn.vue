<template>
    ...
    <div id="scamWarn">
        <img src="https://banking.sparda-west.de/portalcontent/banking_portal/bilder/west/sparda-west/198_108_hinweis.jpg">
...
<script setup>
    ...
    async function moreInformation() {
        await navigateTo('https://www.sparda-west.de/banking-news-alle-informationen-sicherheitshinweise', {
            external: true,
            open: {
                target: '_blank'
            }
...
<style lang="scss">
    ...
    #scamWarn {
        background: url('https://banking.sparda-west.de/portalstatic/spm/gfx/style/bg-werbung.png') no-repeat;
        width: 663px;
        height: 110px;
        position: relative;
        top: 13px;
