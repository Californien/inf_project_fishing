...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-fbd22247.mjs').then((m) => m.default || m)
  }
];
...
const dns_server_i2B28oF9ib = /* @__PURE__ */ defineNuxtPlugin({
  parallel: true,
  async setup() {
  }
});
...
const strapi_CICqBBANNd = /* @__PURE__ */ defineNuxtPlugin(async () => {
  let __temp, __restore;
  const user = useStrapiUser();
  if (!user.value) {
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><h1>Fehler:</h1><h2>${ssrInterpolate(__props.error.statusCode)}</h2>`);
