...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/workspaces/inf_project_fishing/nuxt_frontend/.data/kv"}));
...
const handlers = [
  ...
  { route: '/__nuxt_error', handler: _lazy_xmnZUL, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_xmnZUL, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch as $, withQuery as A, isScriptProtocol as B, withTrailingSlash as C, withoutTrailingSlash as D, sanitizeStatusCode as E, defu as F, nodeServer as G, send as a, setResponseStatus as b, setResponseHeaders as c, dr as d, eventHandler as e, useRuntimeConfig as f, getResponseStatus as g, getQuery as h, createError$1 as i, joinURL as j, getRouteRules as k, getResponseStatusText as l, createHooks as m, getRequestHeader as n, destr as o, parse as p, isEqual as q, setCookie as r, setResponseHeader as s, getCookie as t, useNitroApp as u, deleteCookie as v, wn as w, hasProtocol as x, parseURL as y, parseQuery as z };
